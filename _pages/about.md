...
* <a href="" target="_blank"><strong>Partial Federated Primal-Dual Optimization for Network-Based Android Malware Detection</strong> Accepted</a>(<a href="https://www.computer.org/csdl/proceedings-article/icdcsw/2025/172500a789/2c5NbWQVwcw" target="_blank">webpage</a>)


* <a href="" target="_blank"><strong>Consensus-Constrained Dual-Federated Optimization with Client-Side
...
<div style="display: flex; justify-content: space-between; align-items: flex-start; margin-top: 30px;">
  ...
  <div style="width: 45%; text-align: center;">
    <img src="/images/IRL_method.jpg" alt="IRL Method" style="width: 100%;">
    <p style="margin-top: 10px; font-weight: bold;">IRL Method</p>
  </div>

  <div style="width: 45%; text-align: center;">
    <img src="/images/GPIRL_method.jpg" alt="GPIRL Method" style="width: 100%;">
    <p style="margin-top: 10px; font-weight: bold;">GPIRL Method</p>
  </div>
